...
normal_body = c.create_polygon(
    285,25,220,120,190,230,140,260,120,340,140,360,170,270,170,271,145,340,150,350,240,380,
    345,350,335,310,310,275,311,275,335,315,350,355,365,370,380,330,380,280,315,225,300,140,
    fill="#FA9AA3", smooth = 1,outline="#FD341F", width=2 , 
)
# ================ Happy Body ================ state=HIDDEN
happy_body = c.create_polygon(
    285,25,220,120,190,250,130,140,112,130,110,150,120,220,150,270,160,271,145,340,
    150,350,240,380,345,350,335,310,350,270,380,240,410,150,400,140,390,140,315,240,300,140,
    fill="#FA9AA3", smooth = 1,outline="#FD341F", width=2 , state=HIDDEN
)
# ===== สะดือ =====
c.create_line(
    220,320,230,325,240,325,250,320,
    width=1
)
c.create_line(
    230,310,233,312,237,312,240,310,
    width=1
)

# ===== Legs =====
c.create_polygon(
    170,430,170,430,200,480,220,430,220,430,240,400,260,400,275,440,275,440,305,490,335,420,335,420,320,380,180,350,
    fill="#FA9AA3", smooth = 1,outline="#FD341F", width=2
)
# ===== Pant =====
c.create_polygon(
    151,332,149,332,145,360,160,425,160,425,195,435,235,430,235,420,236,419,215,415,195,410,196,409,215,414,
    236,419,250,420,270,415,271,416,260,420,259,419,260,440,305,440,345,430,335,400,345,330,330,340,220,350,
    fill="#CCE70B", smooth = 1,outline="black", width=2
)
c.create_line(
    150,338,208,352,230,353,295,350,342,342,
    width="2"
)
# ===== Pant Pattern =====
c.create_polygon(
    184,348,180,354,170,370,200,365,180,390,245,400,235,364,250,380,260,380,260,360,255,355,213,357,
    fill="#AF90C4", smooth = 1,outline="#757AB3", width=2
)
c.create_polygon(
    290,438,290,438,275,420,280,400,300,420,290,390,330,390,320,420,335,390,340,434,
    fill="#AF90C4", smooth = 1,outline="#757AB3", width=2
)
# ================================= Eyes ===============================================
# ================ Normal Eyes ================ 
...
devil_smile = c.create_polygon(
    210,180,206,178,240,210,274,182,270,180,240,230,
    fill="#6A0503", smooth = 1,outline="black", width=2, state = HIDDEN
)
# ================ Sad Smile ================ state=HIDDEN
sad_smile = c.create_line(
    210,210,210,200,225,205,230,190,240,200,250,190,260,205,270,200,275,210,
